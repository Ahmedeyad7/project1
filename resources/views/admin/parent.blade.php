    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('admin.course.index') }}" class="nav-link">Course</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('admin.student.index') }}" class="nav-link">Student</a>
                </li>
            </ul>
            <!-- Right navbar links -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="{{ route('admin.home') }}" class="d-block">Team</a>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-header">Content Recourse</li>
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.category.index') }}" class="nav-link">
                                        <i class="fa-solid fa-eye far"></i>
                                        <p>Index</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.category.create') }}" class="nav-link">
                                        <i class="fa-solid fa-square-plus far"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.trainer.create') }}" class="nav-link">
                                        <i class="fa-solid fa-square-plus far"></i>
                                        <p>Create</p>
                                    </a>
                                </li>
